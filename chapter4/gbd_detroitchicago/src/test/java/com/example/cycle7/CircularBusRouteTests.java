...
class CircularBusRouteTests {
  ...
  void testConstructor_whenNoBusStops() {
    ...
    assertThrows(IllegalArgumentException.class, () -> {
      new com.example.cycle6.CircularBusRoute(noBusStops);
  ...
  void testGetNextBusStop_whenOneBusStop() {
    ...
    com.example.cycle6.CircularBusRoute busRoute = new com.example.cycle6.CircularBusRoute(List.of(busStop));
  ...
  void testGetNextBusStop_whenBusStopDoesNotBelongToRoute() {
    ...
    com.example.cycle6.CircularBusRoute busRoute = new com.example.cycle6.CircularBusRoute(List.of(busStopA));
  ...
  void testGetNextBusStop_whenNextBusStopInListExists() {
    ...
    BusStop busStopA = new BusStopImpl();
    BusStop busStopB = new BusStopImpl();
    com.example.cycle6.CircularBusRoute busRoute = new com.example.cycle6.CircularBusRoute(List.of(busStopA, busStopB));
  ...
  void testGetNextBusStop_whenNoNextBusStopInList() {
    ...
    BusStop busStopA = new BusStopImpl();
    BusStop busStopB = new BusStopImpl();
    com.example.cycle6.CircularBusRoute busRoute = new CircularBusRoute(List.of(busStopA, busStopB));
